...
interface SevenSegmentDigitV2Props {
  value: string;
  showDecimal?: boolean;
  className?: string;
}
...
const SevenSegmentDigitV2 = ({ value, showDecimal = false, className }: SevenSegmentDigitV2Props) => {
    ...
    <div className={cn("relative w-full h-full", className)}>
      <svg viewBox="0 0 52 70" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
        ...
        <circle
          ...
          filter={showDecimal ? "url(#glowV2)" : undefined}
        />
...
export default SevenSegmentDigitV2;
