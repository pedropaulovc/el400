  ...
  return (
    <div className="flex flex-col justify-between h-full">
      ...
      <div className="flex gap-3">
        ...
        <DROButton size="square" onClick={() => onNumber('9')} className="p-0">
      ...
      {/* Row 4: +/-, 0, . */}
      <div className="flex gap-3">
        <DROButton size="square" onClick={onSign} className="p-0">
          <Icon name="toggle-sign" alt="Toggle sign" />
        </DROButton>
        <DROButton size="square" onClick={() => onNumber('0')} className="p-0">
          <Icon name="number-0" alt="0" />
        </DROButton>
        <DROButton size="square" onClick={onDecimal} className="p-0">
